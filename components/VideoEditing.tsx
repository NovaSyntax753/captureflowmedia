"use client";
import videoediting from "../assets/videoediting.jpg"; // Update with your video editing image
...
const editingHighlights = [
    {
        icon: "✂️",
        text: "Clean cuts. Smooth transitions. Engaging stories.",
    },
    {
        icon: "🎬",
        text: "Reels that stop the scroll.",
    },
    {
        icon: "🚀",
        text: "Every frame built to convert.",
    },
];
...
export default function VideoEditingSection() {
    return (
        <>
            <section id="video-editing" className="w-full py-16 px-6 lg:px-20 flex flex-col lg:flex-row items-center gap-12">
                {/* Right Image */}
                ...
                <div className="flex-1">
                    ...
                    <p className="mt-6 text-gray-700 leading-relaxed text-left">
                        Your videos shouldn’t just look good — they should make people stop scrolling. Our editing turns raw footage into engaging stories that grab attention and drive action.
                    </p>

                    <h3 className="mt-8 text-xl font-semibold text-left">What we edit:</h3>
