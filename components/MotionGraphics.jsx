"use client";
import motiongraphics from "../assets/motion graphics.jpg"; // Update with your motion graphics image
...
const motionHighlights = [
    {
        icon: "🎬",
        text: "Logos that come alive.",
    },
    {
        icon: "🎞",
        text: "Motion that tells stories.",
    },
    {
        icon: "✨",
        text: "Animations that elevate your brand.",
    },
];
...
export default function MotionGraphicsSection() {
    return (
        <>
            <section id="motion-graphics" className="w-full py-16 px-6 lg:px-20 flex flex-col lg:flex-row items-center gap-12">
                {/* Right Image */}
                ...
                <div className="flex-1">
                    ...
                    <p className="mt-6 text-gray-700 leading-relaxed text-left">
                        Animation creates memorability. Whether it’s logo reveals, explainers, or ad effects, our motion graphics make your brand more dynamic, modern, and unforgettable.
                    </p>

                    <h3 className="mt-8 text-xl font-semibold text-left">What we animate:</h3>
